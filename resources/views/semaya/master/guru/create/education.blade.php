...
<div class="row">
  <div class="col s12 m12 l12 child-content">
    <div class="card-panel">
      <div class="row">
        <form class="col s12 m12 l12" action="{{ route('guru_store_education') }}" method="post" autocomplete="off">
          {!! csrf_field() !!}
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <input id="tmt_inpassing_nonpns" name="tmt_inpassing_nonpns" type="text" class="datepicker">
                <label for="tmt_inpassing_nonpns">TMT Inpassing Guru Non PNS</label>
              </div>
              <div class="input-field col s12 m6 l6">
                <input id="no_sk_inpassing_nonpns" name="no_sk_inpassing_nonpns" type="text" class="validate">
