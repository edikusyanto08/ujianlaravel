...
<html>
  <head>
    ...
    <title>Rekapitulasi Jurusan</title>
  </head>
  <body>
    @php
    ...
    <table {!! $css_table !!}>
      <thead {!! $css_thead !!}>
        <tr>
          ...
          <th rowspan="2" {!! $css_th !!}>Keahlian</th>
          <th colspan="3" {!! $css_th !!}>X</th>
          <th colspan="3" {!! $css_th !!}>XI</th>
          <th colspan="3" {!! $css_th !!}>XII</th>
          <th colspan="2" {!! $css_th !!}>JML</th>
          <th rowspan="2" {!! $css_td_total !!}>Jumlah Total</th>
        </tr>
        <tr>
          <th {!! $css_th !!}></th>
          <th {!! $css_th !!}></th>
      ...
      <tbody>
        @foreach($data as $key => $jur)
          ...
          @endphp
          <tr>
            <td {!! $css_td !!} class="text-center">{{$jur->id}}.</td>
            <td {!! $css_td !!}>{{$jur->kode_jurusan}}</td>
            @php
            ...
            @endphp
            <td {!! $css_td !!} class="text-center">{{$slx}}</td>
            <td {!! $css_td !!} class="text-center">{{$spx}}</td>
            <td {!! $css_td !!} class="text-center">{{$ssx}}</td>
            @php
            ...
            @endphp
            <td {!! $css_td !!} class="text-center">{{$slxi}}</td>
            <td {!! $css_td !!} class="text-center">{{$spxi}}</td>
            <td {!! $css_td !!} class="text-center">{{$ssxi}}</td>
            @php
            ...
            @endphp
            <td {!! $css_td !!} class="text-center">{{$slxii}}</td>
            <td {!! $css_td !!} class="text-center">{{$spxii}}</td>
            <td {!! $css_td !!} class="text-center">{{$ssxii}}</td>
            @php
            ...
            @endphp
            <td {!! $css_td !!} class="text-center">{{$sisl}}</td>
            <td {!! $css_td !!} class="text-center">{{$sisp}}</td>
            <td {!! $css_td_total !!} class="text-center">{{$sis}}</td>
          </tr>
        @endforeach
      </tbody>
    </table>
