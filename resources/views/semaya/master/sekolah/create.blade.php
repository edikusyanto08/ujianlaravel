...
<div class="row">
  <div class="col s12 m12 l12 child-content">
    ...
    <div class="card-panel">
      <div class="row">
        <form class="col s12 m12 l12" action="{{ route('sekolah_store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="row">
            <div class="input-field col s12 m6 l6">
              <input id="npsn" name="npsn" type="text" class="validate" required>
              <label for="npsn">NPSN *</label>
            </div>
            <div class="input-field col s12 m6 l6">
              <input id="nama_sekolah" name="nama_sekolah" type="text" class="validate" required>
          ...
          <div class="row">
            <div class="input-field col s12 m2 l2">
              <input id="kode_area_telp" name="kode_area_telp" type="text" class="validate">
            ...
            <div class="input-field col s12 m5 l5">
              <input id="no_fax" name="no_fax" type="text" class="validate">
          ...
          <div class="row">
            <div class="input-field col s12 m12 l12">
              <input id="daerah_khusus" name="daerah_khusus" type="text" class="validate">
              <label for="daerah_khusus">Daerah Khusus</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12 m12 l12">
              <input id="sk_daerah_khusus" name="sk_daerah_khusus" type="text" class="validate">
