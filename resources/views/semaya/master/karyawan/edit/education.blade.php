...
<div class="row">
  <div class="col s12 m12 l12 child-content">
    ...
    <div class="card-panel">
      <div class="row">
        <form class="col s12 m12 l12" action="{{ route('karyawan_update_education') }}" method="post" autocomplete="off">
          {!! csrf_field() !!}
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="input-field col s12 m6 l6">
                <input id="no_sk_cpns" name="no_sk_cpns" type="text" class="validate" value="{{ $data->no_sk_cpns }}">
            ...
            <div class="row">
              ...
              <div class="input-field col s12 m6 l6">
                <input id="no_sk_pns" name="no_sk_pns" type="text" class="validate" value="{{ $data->no_sk_pns }}">
            ...
            <div class="row">
              <div class="input-field col s12 m12 l12">
                <input id="no_sk_golongan_akhir" name="no_sk_golongan_akhir" type="text" class="validate" value="{{ $data->no_sk_golongan_akhir }}">
                <label for="no_sk_golongan_akhir">No. SK Golongan Terakhir</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12 m2 l2">
                <input id="masa_kerja_th" name="masa_kerja_th" type="text" class="validate" value="{{ $data->masa_kerja_th }}" maxlength="4">
