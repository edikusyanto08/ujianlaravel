  ...
  <div class="col s12 m12 l12 child-content">
    ...
    <div class="card-panel">
      <div class="center row">
        ...
        @else
          <img class="responsive-img" src="{{ url('assets/img/users/karyawan/' . $data->foto) }}" alt="{{ $data->foto }}" width="150">
        @endif
      </div>
      <div class="row">
        <form class="col s12 m12 l12" action="{{ route('karyawan_update') }}" method="post" autocomplete="off" enctype="multipart/form-data">
          {!! csrf_field() !!}
