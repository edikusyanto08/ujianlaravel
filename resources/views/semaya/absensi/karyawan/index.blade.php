  ...
  <div id="modal-search" class="modal">
    <div class="modal-content">
      ...
      <div class="row margin-bottom">
        <form class="col s12" id="formPrint" action="{{ route('absensi_karyawan') }}" method="get">
          <div class="row">
      ...
      <div class="row mar-bot">
        <div class="col s12 m6 l6">
          <ul class="custom-breadcrumb">
            ...
            <li>{{ ucwords(strtolower($data->nama)) }}</li>
          </ul>
        </div>
        <div class="col s12 m6 l6">
          <div class="right">
      ...
      <div class="row margin-bottom">
        <div class="input-field col s12 m12 l12">
          <div class="center">
            ...
            @else
              <img src="{{ 'http://'.Request::server('SERVER_ADDR').'/semaya/public/assets/img/users/karyawan/'.$data->foto }}" alt="{{ $data->foto }}" width="150">
            @endif
          </div>
          <h4 class="center">
            <span class="{{ ($data->kelamin == "P") ? "red-text" : "black-text"}}">{{ ucwords(strtolower($data->nama)) }}</span>
          </h4>
          <h5>
        ...
        <tbody>
          @for ($i=1; $i <= $dom; $i++)
            @php
              ...
              $absen = App\Absensi::where('user_id', $data->nomor_kartu)
