  ...
  <div id="modal-search" class="modal">
    <div class="modal-content">
      ...
      <div class="row margin-bottom">
        <form class="col s12" id="formPrint" action="{{ route('absensi_guru') }}" method="get">
          <div class="row">
      ...
      <div class="row margin-bottom">
        <div class="input-field col s12 m12 l12">
          <div class="center">
            ...
            @else
              <img src="{{ 'http://'.Request::server('SERVER_ADDR').'/semaya/public/assets/img/users/guru/'.$data->foto }}" alt="{{ $data->foto }}" width="150">
            @endif
          </div>
          <h4 class="center">
